<template>
  <DefaultTheme.Layout>
    ...
    <template #home-hero-before>
      <GoHome v-if="frontmatter.goHome" />
    </template>
    <template v-if="!frontmatter.goHome" #home-features-after>
      <Confetti/>
      <HomeUnderline/>
    </template>
    <template v-if="!frontmatter.goHome" #home-hero-info-after>
      <TypeIt
          strings="连接结构、样式与交互，让每一个想法在浏览器中生动呈现。"
