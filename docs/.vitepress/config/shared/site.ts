...
export const head: HeadConfig[] = [
    ...
    ["meta", {
        name: "keywords",
        content: "为知笔记、Go、Golang、并发编程、标准库、后端开发",
    }],
    ["meta", { charset: "UTF-8" }],
];
...
export const siteConfig = {
    ...
    lang: "zh-CN",
    title: "为知笔记",
    titleTemplate: "Go 语言学习笔记",
    description: "为知笔记，系统整理 Go 语言基础、标准库、并发编程与后端工程实践",
    head,
    appearance: true,
    base: VITE_BASE_URL,
    lastUpdated: true,
    sitemap: { hostname: `https://go.weiweixu.cn${VITE_BASE_URL}` },
};
